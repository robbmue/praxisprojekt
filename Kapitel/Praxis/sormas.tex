...
Auf der \ac{GUI} kann dann gechecked werde, ob sich mit den konfigurierten Usern angemeldet werden kann und somit der Login Prozess funktioniert.
...
Dazu wurden zuerst wieder der benötigte Parameter in dem StatefulSet Manifest gesetzt und anschließend die Anwendung ausgerollt.
